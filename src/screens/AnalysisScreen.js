...
import {
  ...
  StyleSheet, StatusBar, SafeAreaView, ActivityIndicator, Clipboard, Linking, Alert,
} from 'react-native';
    ...
    Linking.canOpenURL(mailtoUrl)
      .then((supported) => {
        if (supported) {
          ...
          Alert.alert( // Re-added alert for no email client
            "No Email Client",
            "Cannot open email client. Please ensure you have an email app installed and configured on your device.",
            [{ text: "OK" }]
          );
        }
      })
